    ...
    return (
        <div className="h-screen w-full flex flex-col items-center justify-center z-20 absolute bg-zinc-900/30">
            <div className="flex flex-col w-full lg:w-1/3 lg:max-w-[33%] p-6 gap-4 relative">
                ...
                <h1 className="text-xl text-white">Brayden Tschetter - Portfolio</h1>
                <p className="text-white/90">22 year old mediocre software dev from Manitoba, Canada. Mainly a hobbyist with experience in web apps, databases, server management and some microservices.</p>
                <p className="text-white/90">I am sometimes available for occasional projects.  If you have something you would like made feel free to contact  </p>
            ...
            <p className=" text-neutral-400 text-sm fixed bottom-6 right-6">@ 2023 braydent.dev</p>
