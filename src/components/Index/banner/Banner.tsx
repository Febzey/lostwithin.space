        ...
        <>
            <div className="min-h-[100vh] w-full flex justify-center flex-col items-center z-40 bg-zinc-900 bg-mainBg bg-no-repeat bg-cover">
                <div className="flex flex-col z-40 text-center font-poppins gap-6 md:w-[80%] lg:w-1/3 absolute top-56">
                    <h1 className="text-4xl lg:text-6xl font-semibold"><span className="text-indigo-500">Brayden</span><span className="font-mono">.tech</span></h1>
                ...
                <div className="flex flex-col gap-4 w-full absolute bottom-45 px-8">
                    ...
                    <div className="flex flex-row gap-3 mx-auto">
                        ...
                        <a className="duration-300 motion-safe:hover:-translate-y-7 cursor-pointer" href="https://www.instagram.com/brayden_204/?hl=en"><img src={instagram} height="" width="75" ></img></a>
                    </div>
                </div>
