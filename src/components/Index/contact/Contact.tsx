    ...
    return (
        <div className="w-full min-h-[45vh] bg-slate-600 flex items-center justify-center py-16" id="contact">
            <div className="gap-12 w-[90%] lg:w-[65%] bg-neutral-50 rounded-lg shadow-2xl py-16 lg:px-9 px-3 flex flex-col lg:flex-row">
                ...
                <div className="text-neutral-600 font-poppins lg:text-left text-center flex flex-col gap-2">
                    <h1 className="text-3xl font-semibold">Want something made?</h1>
                    <p className="text-zinc-500">Feel free to contact me at <a href="mailto:braydent1235@gmail.com" className="text-sky-600 hover:text-sky-800">braydent1235@gmail.com</a></p>
                </div>
